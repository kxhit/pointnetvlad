...
int segment_cloud(string pcd_file)
{
    ...
    replace_str(output_file, "submap_ds", "submap_seg_pcd"); // TODO: auto name
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr input_cloud_map(new pcl::PointCloud<pcl::PointXYZI>);
...
//    pcl::io::savePCDFileBinary(OUT_PCD, *cloud_no_ground);

    // Remove outlier
    pcl::RadiusOutlierRemoval<pcl::PointXYZI> outrem;
    outrem.setInputCloud(cloud_no_ground);
    outrem.setRadiusSearch(2.0); //radius 2m
...
//            tmp_pt.b = static_cast<uint8_t>(cloud_no_ground->points[cluster_indices[i].indices[j]].intensity);
            ...
            outfile.write((char*)&tmp_pt.intensity, sizeof(tmp_pt.intensity));
        }
    }
...
{
// TODO: auto mkdirs
    string path = "/media/work/data/kitti/odometry/submap_ds/09";
